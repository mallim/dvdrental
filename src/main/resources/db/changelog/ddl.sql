...
grant select, insert, update, delete, truncate on deps_saved_ddl to public;
...
begin
  ...
  for v_curr in (
    ...
    insert into
      deps_saved_ddl(src_nsp_name, src_rel_name, dep_nsp_name, dep_rel_name, ddl_order, ddl_statement)
    select distinct
      p_src_nsp_name,
      p_src_rel_name,
      v_curr.obj_schema,
